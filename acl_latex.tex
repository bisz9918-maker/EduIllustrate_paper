...
Table~\ref{tab:benchmark-full} lists the complete knowledge point coverage of the 230 benchmark problems, organized by grade level and subject.
...
\hline
\end{tabular}
\caption{Complete knowledge point coverage of the 230 EduIllustrate benchmark problems. Numbers in parentheses indicate problem count per subject-level combination. Some high school mathematics problems have unlabeled knowledge points in the original K12-Vista dataset.}
