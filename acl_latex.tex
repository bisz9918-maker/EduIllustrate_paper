...
\caption{EduIllustrate takes a K-12 STEM problem as input and produces a structured explanation interleaved with geometrically accurate diagrams rendered via Manim. \textit{Left}: the input problem (Grade 9 Mathematics). \textit{Right}: two generated scenes illustrating the inscribed angle theorem and the resulting right triangle used to compute $AB = 3$.}
\label{fig:teaser}
\end{figure*}
