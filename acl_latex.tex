...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.6\linewidth]{fig/fig_radar.pdf}
  \caption{Radar chart of 8-dimension scores for all 10 models (0--100\% scale).}
  \label{fig:radar}
\end{figure*}
