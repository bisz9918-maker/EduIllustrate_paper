...
\hline
Gemini 3.0 Pro Preview & 4.38 & 4.74 & 4.37 & 3.92 & 4.92 & 4.23 & 4.47 & 4.63 & \textbf{4.39} \\
Kimi-K2.5 & 4.26 & 4.61 & 3.57 & 3.67 & 4.87 & 3.44 & 4.43 & 4.31 & \textbf{4.04} \\
Claude Sonnet 4.5 & 2.76 & 2.94 & 2.13 & 2.38 & 3.87 & 3.20 & 4.21 & 3.44 & \textbf{2.89} \\
GPT-5 & 2.95 & 3.34 & 2.22 & 2.20 & 3.71 & 2.96 & 4.60 & 3.19 & \textbf{2.90} \\
Qwen 3.5-35B & 4.17 & 4.45 & 1.98 & 3.46 & 4.39 & 2.68 & 4.43 & 2.75 & \textbf{3.29} \\
\hline
\end{tabular}
...
All models excel at Logical Coherence and Typographic Clarity (scores $\geq$ 2.94), reflecting LLMs' strength in coherent, well-formatted text generation. Text--Diagram Coordination achieves high scores even for weaker models (Claude: 4.21, GPT-5: 4.60), indicating models produce well-integrated textual references to diagrams regardless of diagram quality. Critical weaknesses appear in Diagram--Problem Alignment, where scores range from 1.98 to 4.37. Qwen's low score of 1.98 reflects frequent semantic misalignment---geometrically valid diagrams that do not match problem specifications. Pedagogical Effectiveness is universally weakest (2.20-3.92), indicating all models struggle with grade-appropriate language and scaffolding strategies. Failure rates on the 230-problem benchmark vary substantially: Kimi-K2.5 is most robust (4 failures, 1.7\%), followed by Gemini (6, 2.6\%), Claude (9, 3.9\%), GPT-5 (24, 10.4\%), and Qwen (37, 16.1\%). Failed problems are excluded from scoring; reported scores reflect only successfully completed problems.
...
\hline
Gemini 3.0 Pro Preview & 4.47 & 4.36 & 4.24 & 4.14 & 4.19 & & 4.34 & 4.32 & 4.35 \\
Kimi-K2.5              & 4.19 & 4.03 & 3.85 & 3.94 & 3.77 & & 4.00 & 4.01 & 4.03 \\
Claude Sonnet 4.5      & 3.03 & 2.89 & 2.46 & 2.48 & 2.48 & & 3.21 & 2.67 & 2.79 \\
GPT-5                  & 2.99 & 2.88 & 2.49 & 1.90 & 2.15 & & 3.43 & 2.69 & 2.47 \\
Qwen 3.5-35B           & 3.32 & 2.94 & 3.14 & 2.81 & 2.62 & & 3.67 & 2.97 & 3.00 \\
\hline
\end{tabular}
...
\hline
Ours & 46.8K / 37.1K & 0.54 & 4.94 & 4.47 & \textbf{4.39} \\
All-Parallel & 95.5K / 71.4K & 1.05 & 7.32 & 3.89 & \textbf{4.29} \\
\hline
\end{tabular}
\caption{Workflow comparison using Gemini 3.0 Pro Preview on 50 problems. Our workflow achieves superior visual consistency at lower cost and latency.}
\label{tab:workflow}
\end{table*}
...
Table~\ref{tab:cost} presents cost and latency metrics. As shown in Figure~\ref{fig:cost-quality}, Kimi offers the best cost-efficiency at \$0.12/problem (4.04 score), representing only 8.0\% quality degradation relative to Gemini (\$0.54, 4.39 score) at 4.5$\times$ lower cost. Qwen is cheapest (\$0.04) but sacrifices 25\% quality.
...
\hline
Claude Sonnet 4.5 & 71,889 & 23,964 & 3.00 & 15.00 & 0.58 & 6.92 \\
Gemini 3.0 Pro Preview & 46,821 & 37,096 & 2.00 & 12.00 & 0.54 & 4.94 \\
GPT-5 & 34,568 & 10,178 & 1.25 & 10.00 & 0.14 & 7.67 \\
Kimi-K2.5 & 44,537 & 43,628 & 0.45 & 2.20 & 0.12 & 6.34 \\
Qwen 3.5-35B & 37,269 & 24,943 & 0.16 & 1.30 & 0.04 & 5.34 \\
\hline
\end{tabular}
\caption{Cost and latency analysis per problem (230 problems, average values).}
\label{tab:cost}
\end{table*}
...
\begin{figure}[t]
  ...
  \caption{Cost vs.\ quality trade-off across five models. X-axis: average cost per problem (USD); Y-axis: overall score (0--5). Kimi-K2.5 offers the best cost-efficiency, achieving 4.04 at \$0.12/problem.}
  \label{fig:cost-quality}
\end{figure}

\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{fig/fig_cost_breakdown.png}
  \caption{Per-stage cost breakdown across five models. Each bar decomposes the average per-problem cost into three pipeline stages: Scene Outline, Implementation Plans, and Scene Rendering. Scene Rendering dominates cost for all models.}
