...
%%
%% =====================================================================
%% 【P2】Multimodal Interleaved Reasoning 是当前热点（非相关工作综述）
%% =====================================================================
%%
%% 逻辑链：
%%   交织生成是当前研究热点 \citep{zheng2023interleaved}
%%   → 现有工作聚焦模型能力本身（幻觉、推理），尚无人系统应用于K-12教育内容生成
%%     \citep{liu2025rh}（RH-AUC, 幻觉评测）
%%   → 我们是首个在K-12 STEM场景下系统实现multimodal interleaved生成的工作
%%
%% 注意：P2是motivation段，不是related work综述
%%
%% =====================================================================
%% 【P3】双重空白（把相关工作折叠进来）
%% =====================================================================
%%
%% Gap 1 — 生成层面：
%%   A. 视频生成（大学级别）: \citep{ku2025theoremexplain}, \citep{chen2025code2video}
%%   B. 纯文字生成: \citep{liu2025cogent}, \citep{wang2025genmentor}
%%   C. 无K-12图文交织生成系统（待补充3-5篇文献）
%%
%% Gap 2 — 评价层面：
%%   \citep{kumar2025diagramir}（图表评测，但非K-12，非多学科）
%%   \citep{ji2025eduvis}（EduVisBench，可视化推理，非生成评测）
%%   → 无benchmark同时评K-12多模态内容的文字质量+视觉质量
%%
%% =====================================================================
...
%% =====================================================================
%% 待办：
%% [ ] P2: 确认zheng2023interleaved (2310.02239) 和 liu2025rh (2505.21523) 引用正确
%% [ ] P3: 补充类别C相关工作（约需3-5篇文献，K-12图文/插图生成方向）
%% [ ] 写完整draft文本（当前只有P1草稿句）
%% =====================================================================
\end{comment}
